    ...
    datasets: [
      {
        ...
        backgroundColor: isDark ? 'rgba(0, 240, 255, 0.15)' : 'rgba(0, 160, 190, 0.15)',
        borderColor: isDark ? '#00f0ff' : '#00a0be',
        borderWidth: 2,
        pointBackgroundColor: isDark ? '#00f0ff' : '#00a0be',
        pointBorderColor,
        pointBorderWidth: 2,
        pointRadius: 4,
      },
      {
        ...
        backgroundColor: isDark ? 'rgba(180, 74, 255, 0.08)' : 'rgba(140, 50, 210, 0.08)',
        borderColor: isDark ? '#b44aff' : '#8c32d2',
        borderWidth: 2,
        borderDash: [4, 4],
        pointBackgroundColor: isDark ? '#b44aff' : '#8c32d2',
        pointBorderColor,
        pointBorderWidth: 2,
        pointRadius: 3,
      },
